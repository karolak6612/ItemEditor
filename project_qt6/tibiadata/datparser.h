...
#include "otb/item.h" // For OTB::ClientItem (to populate)
#include <QString>
#include <QFile>
#include <QDataStream>
#include <QMap>
...
public:
    ...
    bool getAllClientItems(QMap<quint16, OTB::ClientItem>& outItemsMap, bool extendedFormat) const;
...
private:
    bool parseThing(QDataStream& stream, quint16 clientId, OTB::ClientItem& outItem, bool extendedFormat) const;
    ...
    QMap<quint16, OTB::ClientItem> m_parsedClientItems;
};
