...
public:
    ...
    // Populates the passed ItemEditor::Sprite object.
    // Returns true if sprite found and successfully parsed.
    bool getSprite(quint32 spriteId, ItemEditor::Sprite& outSprite, bool transparent = true) const;

    quint32 getSpriteCount() const;
    quint32 getSignature() const;

private:
    bool parseSpriteData(quint32 spriteId, QDataStream& stream, ItemEditor::Sprite& outSprite, bool transparent) const;
