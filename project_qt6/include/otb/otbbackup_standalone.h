#ifndef OTBBACKUP_STANDALONE_H
#define OTBBACKUP_STANDALONE_H
...
// Simplified backup system class (without QObject inheritance)
class OtbBackupSystemStandalone {
public:
    explicit OtbBackupSystemStandalone();
    ~OtbBackupSystemStandalone();
...
private:
    ...
    bool validateFileBasic(const QString& filePath) const;
...
// Use the standalone version as the main type for testing
using OtbBackupSystem = OtbBackupSystemStandalone;

} // namespace OTB

#endif // OTBBACKUP_STANDALONE_H