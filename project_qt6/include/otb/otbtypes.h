...
struct ServerItem {
    ...
    bool equals(const ServerItem& other) const; // Use ServerItem instead of ItemBase to avoid circular dependency
    void copyPropertiesFrom(const ServerItem& source); // Use ServerItem instead of ItemBase
};
