                           ...
                           QString& errorString)
{
    ...
    item100.type = static_cast<quint8>(OTB::ServerItemType::Ground); // Example
    item100.width = 1;
    item100.height = 1;
    item100.layers = 1;
    item100.frames = 1;
    ...
    item101.type = static_cast<quint8>(OTB::ServerItemType::Container);
    ...
    item3039.type = static_cast<quint8>(OTB::ServerItemType::Ground);
