...
{
    Q_OBJECT
    // Q_PLUGIN_METADATA(IID IPlugin_iid FILE "dummyplugin.json") // Commented out for static linking
...
public:
    ...
    bool Initialize() override { return true; }; // C# IPlugin has this, return true for success
