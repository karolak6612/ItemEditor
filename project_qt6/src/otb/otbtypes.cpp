#include "otbtypes.h"
// #include "item.h" // Commented out for minimal test
// For ItemBase, which ServerItem methods will interact with
...
bool ServerItem::equals(const ServerItem& other) const {
...
void ServerItem::copyPropertiesFrom(const ServerItem& source) {
