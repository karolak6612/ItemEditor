...
bool SprParser::getSprite(quint32 spriteId, ItemEditor::Sprite& outSprite, bool transparent) const
{
...
bool SprParser::parseSpriteData(quint32 spriteId, QDataStream& stream, ItemEditor::Sprite& outSprite, bool isTransparentByDefault) const
{
